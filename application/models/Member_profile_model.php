	...
	*/
	public function read($start_row, $per_page)
	{
		...
		$this->db->select("$this->my_table.*, tb_department_1.dpm_name AS departmentIdDepartmentName
				, tb_members_2.firstname AS createUserIdfirstname, tb_members_2.lastname AS createUserIdLastname
				, _doc_tb_members_3.firstname AS modifyUserIdfirstname, _doc_tb_members_3.lastname AS modifyUserIdLastname
				");
