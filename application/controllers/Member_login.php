...
class Member_login extends CRUD_Controller
{
    ...
    function __construct(){
		...
		$this->data['page_title'] = 'THITARAM - LOGIN';
	...
	protected function render_view($path)
	{
		$template_name = 'sb-admin-bs4';
		 ...
		 $this->data['top_navbar'] = $this->parser->parse('template/mainlogin/top_navbar_view', $this->top_navbar_data, TRUE);
		$this->data['left_sidebar'] = $this->parser->parse('template/mainlogin/left_sidebar_view', $this->left_sidebar_data, TRUE);
		$this->data['breadcrumb_list'] = $this->parser->parse('template/mainlogin/breadcrumb_view', $this->breadcrumb_data, TRUE);
		 $this->data['page_content'] = $this->parser->parse_repeat($path, $this->data, TRUE);
		 $this->data['another_css'] = $this->another_css;
		 $this->data['another_js'] = $this->another_js;
		 $this->parser->parse('template/mainlogin/homepage_view', $this->data);
	}
