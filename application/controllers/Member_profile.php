...
class Member_profile extends MEMBER_Controller
{
	...
	private function setPreviewFormat($lists_data)
	{
		...
		if($data['create_user_id'] != ''){
			$titleRow = $this->Profile->getRowOf($this->tbMember, 'firstname, lastname', "userid = $data[create_user_id]", $this->db);
			$createUserIdfirstname = $titleRow['firstname'];
			$createUserIdLastname = $titleRow['lastname'];
		}
		$this->data['record_create_firstname'] = $createUserIdfirstname;
		$this->data['record_create_lastname'] = $createUserIdLastname;

		$modifyUserIdfirstname = '';
		$modifyUserIdLastname = '';
		if($data['modify_user_id'] != ''){
			$titleRow = $this->Profile->getRowOf($this->tbMember, 'firstname, lastname', "userid = $data[modify_user_id]", $this->db);
			$modifyUserIdfirstname = $titleRow['firstname'];
			$modifyUserIdLastname = $titleRow['lastname'];
		}
		$this->data['record_modify_firstname'] = $modifyUserIdfirstname;
