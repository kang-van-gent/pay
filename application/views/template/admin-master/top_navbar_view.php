...
<ul class="navbar-nav ml-auto ml-md-0">
	...
	<li class="nav-item dropdown no-arrow">
		<a class="nav-link {login_inactive_class}" 
			 title="ล็อกอินเข้าใช้งาน"
			href="{site_url}/member/login" >
			<i class="fas fa-user-circle fa-fw"></i>
		</a>
		
		<a class="nav-link dropdown-toggle {login_active_class}" 
			href="#" title="ข้อมูลสมาชิก" id="userDropdown" role="button" 
