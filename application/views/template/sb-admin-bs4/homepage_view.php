...
<head>
    ...
    <meta name="author" content="">
     ...
     <title>989PAY พนักงานทิตาราม</title>

     <link href="https://fonts.googleapis.com/css?family=Nunito+Sans:300,400,600,700,800" rel="stylesheet">
 		<link rel="icon" href="{base_url}assets/themes/admin-master/favicon.ico" type="image/x-icon" />
         <link rel="stylesheet" href="{base_url}assets/themes/admin-master/plugins/ionicons/dist/css/ionicons.min.css">
        <link rel="stylesheet" href="{base_url}assets/themes/admin-master/plugins/icon-kit/dist/css/iconkit.min.css">

    <!-- Bootstrap core CSS-->
    <link href="{base_url}assets/themes/sb-admin-bs4/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom fonts for this template-->
 	<link rel="stylesheet" href="{base_url}assets/themes/admin-master/plugins/fontawesome-free/css/all.min.css" type="text/css">
 ...
 <!--    <link href="{base_url}assets/themes/sb-admin-bs4/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css"> -->
  ...
  <!--   <link href="{base_url}assets/themes/sb-admin-bs4/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet"> -->
    <link rel="stylesheet" href="{base_url}assets/themes/admin-master/plugins/datatables.net-bs4/css/dataTables.bootstrap4.min.css">

    <!-- Custom styles for this template-->
    <link rel="stylesheet" href="{base_url}assets/themes/admin-master/dist/css/theme.min.css">
<!--<link rel="stylesheet" href="{base_url}assets/themes/admin-master/plugins/owl.carousel/dist/assets/owl.theme.default.min.css"> -->
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
        ...
        <a class="navbar-brand mr-1" href="{site_url}"><b>989PAY</b></a>
            ...
            <footer class="sticky-footer">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright © Thitaram Group : V2021.01 </span>
                    </div>
                </div>
            </footer>
    ...
    <!-- Page level plugin JavaScript-->
	   ...
	   <script src="{base_url}assets/themes/admin-master/plugins/datatables.net/js/jquery.dataTables.min.js"></script>
        <script src="{base_url}assets/themes/admin-master/plugins/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
        <script src="{base_url}assets/themes/admin-master/plugins/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
        <script src="{base_url}assets/themes/admin-master/js/datatables.js"></script>
