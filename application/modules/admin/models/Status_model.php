...
class Status_model extends MY_Model
{
	...
	{
		$status_id = checkEncryptData($data['status_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.status_id = $status_id");
	...
	{
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.status_id = $id");
	...
	*/
	...
	public function update($post)
	{
		...
		$status_id = checkEncryptData($post['encrypt_status_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.status_id = $status_id");
