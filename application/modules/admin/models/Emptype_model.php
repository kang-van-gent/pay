 ...
 * @date 2020-11-17
 */
class Emptype_model extends MY_Model
{
	...
	{
		$emptype_Id = checkEncryptData($data['emptype_Id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.emptype_Id = '$emptype_Id'");
	...
	{
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.emptype_Id = '$id'");
	...
	public function create($post)
	{
		...
		$data = array(
				'emptype_Id' => $post['emptype_Id']
				,'emptype_name' => $post['emptype_name']
		);
		$this->set_table_name($this->my_table);
	...
	*/
	...
	public function update($post)
	{
		...
		$emptype_Id = checkEncryptData($post['encrypt_emptype_Id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.emptype_Id = '$emptype_Id'");
