 ...
 * @date 2020-05-27
 */
class Nationl_model extends MY_Model
{
	...
	{
		$nat_id = checkEncryptData($data['nat_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.nat_id = $nat_id");
	...
	{
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.nat_id = $id");
	...
	*/
	...
	public function update($post)
	{
		...
		$nat_id = checkEncryptData($post['encrypt_nat_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.nat_id = $nat_id");
