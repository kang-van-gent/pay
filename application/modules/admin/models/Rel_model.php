 ...
 * @date 2020-05-27
 */
class Rel_model extends MY_Model
{
	...
	{
		$rel_id = checkEncryptData($data['rel_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.rel_id = $rel_id");
	...
	{
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.rel_id = $id");
	...
	*/
	...
	public function update($post)
	{
		...
		$rel_id = checkEncryptData($post['encrypt_rel_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.rel_id = $rel_id");
