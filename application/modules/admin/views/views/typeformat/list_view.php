...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ข้อมูล<b>พนักงานประจำสาขา</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			<div class="col-sm-12 col-md-12 mb-3">
				...
				<i class="fa fa-plus-square"></i></span> เพิ่มพนักงานใหม่
				</a>			
			</div>
		</div>
			<div class="col-sm-12 col-md-9">
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<option value="formart_textcode">รหัสรายรับ/รายหัก</option>
					<option value="formart_textname">ประเภทรายรับ/รายหัก</option>
					</select>
 					</div>
			...
			<div class="col-sm-12 col-md-3">
				<div class="pull-right text-right">
					...
					<option value="formart_textcode|asc">รหัสรายรับ/รายหัก A-Z</option>
					<option value="formart_textcode|desc">รหัสรายรับ/รายหัก Z-A</option>
					<option value="formart_textname|asc">ประเภทรายรับ/รายหัก A-Z และ ก-ฮ</option>
					<option value="formart_textname|desc">ประเภทรายรับ/รายหัก Z-A และ ฮ-ก</option>
						</select>
 					</div>
				</div>
			</div>
			...
			<table class="table table-bordered table-striped table-hover">
				<thead class="info">
					<tr bgcolor="#dddddd">
						...
						<!-- <th>รูป</th>	 -->			
						<th width="15%;">ID</th>																	
						<th width="30%;">รหัสรายรับ/รายหัก</th>						
						<th width="30%;">ประเภทรายรับ/รายหัก</th>
					</tr>
				</thead>
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						<td style="text-align:center;">
							 <div class="dropdown">
								...
								<div class="dropdown-menu" aria-labelledby=""style="text-align:center;">
								...
								<a href="{site_url}/module_edit/employee/edit/{url_encrypt_id}" target="_blank" 
									class="my-tooltip btn btn-warning btn-sm"
									data-toggle="tooltip" title="แก้ไขข้อมูล">
									Edit
								</a>
								<a href="{site_url}/module_resign/employee/edit/{url_encrypt_id}" target="_blank" 
						...
						<td>{format_id}</td>
						<td>{formart_textcode}</td>
						<td>{formart_textname}</td>
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_emp_id" />
