<!--  [ View File name : edit_view.php ] -->
	...
	<div class="card">
		<div class="card-header bg-info">
			<h3 class="card-title"><i class="fa fa-edit"></i> แก้ไขข้อมูล สมาชิก</h3>
		</div>
	<div class="card-body">
	...
	<div class="row">
        <div class="col-xl-6 col-md-6">
				...
				<div class='form-group'>
					<label class='col-md-3 col-6 control-label' for='userid'>*userid  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-md-3 col-6 control-label' for='void'>*สถานะ  :</label>
					<div class='col-sm-10'>
 		...
 		<div class="col-xl-6 col-md-6">
				...
				<div class='form-group'>
           		...
           		<div class='form-group'>
					<label class='col-md-3 col-6 control-label' for='department_id'>ชื่อสังกัด  :</label>
					<div class='col-sm-10'>
