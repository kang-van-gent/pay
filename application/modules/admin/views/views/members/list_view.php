...
<div class="card">
	<div class="card-header bg-info">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูลสมาชิก</h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="input-group input-group-button">
				...
				<a href="{page_url}" class="btn btn-info">ทั้งหมด</a>
					...
					<option value="firstname">ชื่อสมาชิก</option>
					<option value="lastname">นามสกุล</option>
					<!-- <option value="level">สิทธิ์การใช้งาน</option> -->
						</select>
 					</div>
					<div class="form-group">
		...
		<table id="simpletable" class="table table-striped table-bordered nowrap">
				...
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<!-- <td>{preview_photo}</td> -->
						<td>{username}</td>
						<td>{prefixPreName}	{firstname} {lastname}</td>
