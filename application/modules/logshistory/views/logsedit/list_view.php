...
<div class="card">
	<div class="card-header bg-info">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ History Edit</h3>
	</div>
	<div class="card-body">
		<div class="row">

			<div class="col-sm-12 col-md-9">
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search_date">
				...
				<div class="input-group input-group-button">
					...
					<div class="form-group">
						...
						<option value="log_edit_datetime">Date Edit</option>
						</select>
 					</div>
 					
					<div class="form-group">					
					<input type="text" class="form-control  datepicker" id="begin_date" placeholder="ตั้งแต่วันที่" name="begin_date" value="{txt_search}">
					</div>			
					
					<div class="form-group">					
					<input type="text" class="form-control  datepicker" id="final_date" placeholder=" ถึงวันที่ " name="final_date" value="{txt_search}">
					</div>
		...
		<table id="simpletable" class="table table-striped table-bordered nowrap">
				...
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<td>{log_edit_datetime}</td>
						<td>{log_edit_remark}</td>
						<td>{log_edit_condition}</td>
						<td>{log_login_ip}</td>
					</tr>
				</tbody>
			</table>
