...
<div class="card">
	<div class="card-header bg-info">
		<h3 class="card-title"><i class="fa fa-list-alt"></i><b> ตารางแสดงรายการ ข้อมูลสาขา</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-9">
				...
				<div class="input-group input-group-button">
					...
					<option value="branch_name">สาขา</option>
					<option value="branch_nick">ชื่อย่อสาขา</option>
						</select>
 					</div>
					<div class="form-group">
