		...
		<div class="card-body">
			<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_id'>id  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_name'>*ชื่อสาขา  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_nick'>*ชื่อย่อสาขา  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_social'>*เลข สปส  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_tax'>*เลข ภาษี  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_address'>ที่อยู่  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_ampur'>อำเภอ  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='rf_city_id'>จังหวัด  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_zip'>รหัสไปรษณีย์  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_tel'>เบอร์โทร  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_fax'>เบอร์branch_fax  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_des'>รายละเอียด  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_logo'>logo  :</label>
					<div class='col-sm-10'>
				...
				<div class="col">
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='rf_formart_id'>รูปแบบรายรับรายหัก  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='pay_month'>จำนวนวันทำงานใน 1 เดือน  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='pay_worktime'>จำนวน ชม./วัน  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='atm_attach'>หักเงินเข้าบัญชี  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='num_datepass'>จำนวนวันผ่านทดลองงาน  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='rf_bank_id'>ธนาคารที่ใช้เข้า ATM  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='rf_pay_satangpay'>ประเภทปัดเศษจ่ายเงินสด  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='rf_tax_satangpay'>ประเภทปัดเศษเงินภาษี  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='num_dateacc'>คืนประกันพนักงานอายุครบ  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='num_datest'>หักค่าชุดพนักงานอายุงานไม่ถึง  :</label>
					<div class='col-sm-10'>
				...
				<br>
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_ssonum'>ประกันสังคมลำดับสาขา  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='branch_social'>เลขบัญชีประกันสังคม  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='sso_min'>ค่าจ้างประกันสังคมขั้นต่ำ  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='sso_max'>ค่าจ้างสูงสุด  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='sso_prde'>เปอร์เซ็น  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='fun_customer'>รหัสบริษัท  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='fun_number'>รหัสกองทุน  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='fun_bankpv'>นโยบายกองทุน  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='rf_funtype_id'>ประเภทคิดกองทุน  :</label>
					<div class='col-sm-10'>
				...
				<div class='form-group'>
					<label class='col-sm-4 control-label' for='rf_fun_satangpay'>ประเภทปัดเศษเงินทุน  :</label>
					<div class='col-sm-10'>
