...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>ฝ่าย</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-9">
				...
				<div class="input-group input-group-button">
					...
					<option value="depbranch_code">รหัสฝ่าย</option>
					<option value="depbranch_name">ฝ่าย</option>
					<option value="dep_branch_code">สาขา</option>
						</select>
 					</div>
					<div class="form-group">
...
<!-- 				<div class="pull-right text-right">
					...
					<option value="depbranch_code|asc">รหัสฝ่าย ก - ฮ</option><option value="depbranch_code|desc">รหัสฝ่าย ฮ - ก</option><option value="depbranch_name|asc">ฝ่าย ก - ฮ</option><option value="depbranch_name|desc">ฝ่าย ฮ - ก</option><option value="dep_branch_code|asc">สาขา ก - ฮ</option><option value="dep_branch_code|desc">สาขา ฮ - ก</option>
						</select>
 					</div>
				</div> -->
			</div>
			...
			<table id="simpletable" class="table table-striped table-bordered nowrap">
				...
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<!-- <td>{depbranch_id}</td> -->
						<td>{depbranch_code}</td>
						<td>{depbranch_name}</td>
...
<!-- 								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-depbranch_id = "{encrypt_depbranch_id}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_depbranch_id" />
