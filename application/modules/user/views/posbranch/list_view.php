...
<div class="card">
	<div class="card-header bg-primary">
		<h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ ข้อมูล<b>ตำแหน่ง</b></h3>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-9">
				<form class="form-inline well well-sm" name="formSearch" method="post" action="{page_url}/search">
					...
					<option value="posbranch_code">รหัสตำแหน่ง</option>
					<option value="posbranch_name">ตำแหน่ง</option>
					<option value="pos_branch_code">สาขา</option>
						</select>
 					</div>
					<div class="form-group">
...
<!-- 				<div class="pull-right text-right">
					...
					<option value="posbranch_code|asc">รหัสตำแหน่ง ก - ฮ</option><option value="posbranch_code|desc">รหัสตำแหน่ง ฮ - ก</option><option value="posbranch_name|asc">ตำแหน่ง ก - ฮ</option><option value="posbranch_name|desc">ตำแหน่ง ฮ - ก</option><option value="pos_branch_code|asc">สาขา ก - ฮ</option><option value="pos_branch_code|desc">สาขา ฮ - ก</option>
						</select>
 					</div>
				</div> -->
			...
			<table id="simpletable" class="table table-striped table-bordered nowrap">
				...
				<tbody>
					<tr parser-repeat="[data_list]" id="row_{record_number}">
						...
						<!-- <td>{posbranch_id}</td> -->
						<td>{posbranch_code}</td>
						<td>{posbranch_name}</td>
...
<!-- 								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-posbranch_id = "{encrypt_posbranch_id}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_posbranch_id" />
