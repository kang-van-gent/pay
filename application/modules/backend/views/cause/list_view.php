...
<div class="card">
  ...
  <div class="card-body">
    <div class="row">
	   ...
	   <h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ : สาเหตุที่ออก[บริษัท]</h3>
       </div>
			...
			<table id="simpletable" class="table table-striped table-bordered nowrap">
				<thead class="info">
					<tr bgcolor="#dddddd">
						...
						<th>รหัสสาเหตุที่ออก</th>
						<th width="70%;">สาเหตุที่ออก</th>
...
<!-- 								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-cause_id = "{encrypt_cause_id}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_cause_id" />
