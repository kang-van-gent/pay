...
<div class="card">
  ...
  <h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ : สาเหตุที่ออก[สปส]</h3>
     </div>
	...
	<div class="dt-responsive">
			...
			<table id="simpletable" class="table table-striped table-bordered nowrap">
				<thead class="info">
					<tr bgcolor="#dddddd">
						<th>รหัส</th>
						<th width="25%;">สาเหตุที่ออก</th>
						<th>โค้ดสาเหตุที่ออก</th>
...
<!-- 								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-ssocause_id = "{encrypt_ssocause_id}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_ssocause_id" />
