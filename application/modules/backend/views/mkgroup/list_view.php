...
<div class="card">
  <div class="card-body">
    <div class="row">
	   ...
	   <h3 class="card-title"><i class="fa fa-list-alt"></i> ตารางแสดงรายการ : ประเภทของสาขา</h3>
       </div>
			...
			<table id="simpletable" class="table table-striped table-bordered nowrap">
				<thead class="info">
					<tr bgcolor="#dddddd">
						...
						<th>id</th>
						<th>ประเภทของสาขา</th>
						<th class="text-center" style="width:50px">จัดการ</th>
					</tr>
				</thead>
				<tbody>
...
<!-- 								<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger btn-sm"
									data-toggle="tooltip" title="ลบรายการนี้"
									 data-mkgroup_id = "{encrypt_mkgroup_id}" data-row-number="{record_number}">
...
<label class="col-sm-3 text-right badge badge-warning" for="edit_remark">ระบุเหตุผล :</label>
					...
					<input type="hidden" name="encrypt_mkgroup_id" />
