...
class Hospital_model extends MY_Model
{
	...
	{
		$hospital_id = checkEncryptData($data['hospital_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.hospital_id = '$hospital_id'");
	...
	{
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.hospital_id = '$id'");
	...
	*/
	...
	public function update($post)
	{
		...
		$hospital_id = checkEncryptData($post['encrypt_hospital_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.hospital_id = '$hospital_id'");
