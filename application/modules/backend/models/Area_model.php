...
class Area_model extends MY_Model
{
	...
	{
		$area_id = checkEncryptData($data['area_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.area_id = $area_id");
	...
	{
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.area_id = $id");
	...
	*/
	...
	public function update($post)
	{
		...
		$area_id = checkEncryptData($post['encrypt_area_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.area_id = $area_id");
