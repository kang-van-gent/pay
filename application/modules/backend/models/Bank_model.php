...
class Bank_model extends MY_Model
{
	...
	{
		$bank_id = checkEncryptData($data['bank_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.bank_id = '$bank_id'");
	...
	{
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.bank_id = '$id'");
	...
	*/
	...
	public function update($post)
	{
		...
		$bank_id = checkEncryptData($post['encrypt_bank_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.bank_id = '$bank_id'");
