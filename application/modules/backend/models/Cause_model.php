...
class Cause_model extends MY_Model
{
	...
	{
		$cause_id = checkEncryptData($data['cause_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.cause_id = $cause_id");
	...
	{
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.cause_id = $id");
	...
	*/
	...
	public function update($post)
	{
		...
		$cause_id = checkEncryptData($post['encrypt_cause_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.cause_id = $cause_id");
