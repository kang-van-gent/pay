...
class City_model extends MY_Model
{
	...
	{
		$city_id = checkEncryptData($data['city_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.city_id = '$city_id'");
	...
	{
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.city_id = '$id'");
	...
	*/
	...
	public function update($post)
	{
		...
		$city_id = checkEncryptData($post['encrypt_city_id']);
		$this->set_table_name($this->my_table);
		$this->set_where("$this->my_table.city_id = '$city_id'");
