...
var Bank = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('backend/bank/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('backend/bank/save');
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('backend/bank/update');
	...
	confirmDelete: function (pBankId,  irow){
		$('[name="encrypt_Bank_id"]').val(pBankId);
	...
	deleteRecord: function(){
		var frm_action = site_url('backend/bank/del');
...
$(document).ready(function() {
	...
	$(document).on('click','.btn-delete-row', function(){
		...
		var pBankId = $(this).attr('data-Bank_id');

		Bank.confirmDelete(pBankId,  row_num);
	});//click
