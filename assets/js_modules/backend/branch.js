...
var Branch = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('backend/branch/preview_ajax/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('backend/branch/save');
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('backend/branch/update');
	...
	confirmDelete: function (pBranchId,  irow){
		$('[name="encrypt_branch_id"]').val(pBranchId);
	...
	deleteRecord: function(){
		var frm_action = site_url('backend/branch/del');
...
$(document).ready(function() {
	...
	$(document).on('click','.btn-delete-row', function(){
		...
		var pBranchId = $(this).attr('data-branch_id');

		Branch.confirmDelete(pBranchId,  row_num);
	});//click
