...
var Members = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('admin/members/preview/'+ id),
	...
	saveFormData: function(){
		var frm_action = site_url('admin/members/save');
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('admin/members/update');
	...
	deleteRecord: function(){
		var frm_action = site_url('admin/members/del');
...
$(document).ready(function() {
	...
	setDropdownList('#prefix',360);
	setDropdownList('#level',360);
	setDropdownList('#department_id',360);
	setDropdownList('#void',360);
